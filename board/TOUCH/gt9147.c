...
u8 GT9147_Init(void)
{
  ...
  RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB, ENABLE);//使能GPIOB时钟
    ...
    //GPIOB1初始化设置
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13;//PB1设置为上拉输入  中断引脚
  ...
  GPIO_Init(GPIOB, &GPIO_InitStructure);//初始化
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_14;//PC13设置为推挽输出 //复位引脚
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13;//PB1设置为浮空输入
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//输出模式
